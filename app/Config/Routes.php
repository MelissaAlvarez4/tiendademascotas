...
$routes->resource('/buscar/todos', ['controller' => 'ColitasRestController']);

$routes->get('/', 'ColitasControlador::index');
$routes->get('/buscar/nombre', 'ColitasControlador::buscarNombre');
$routes->get('/buscar/protectora', 'ColitasControlador::buscarProtectora');
